...
def plot_confusion_matrix(conf_matrix,tau, C):
    ...
    conf_num = "../conf/pegasos_conf_test/" + str(tau) + "_" + str(C) + ".png"
...
for tau, C in product(taus, Cs):
    ...
    pegasos_mod_num = "../model/mod_pegasos__pauli_test_" + str(tau)+'_'+str(C) + ".model"
    model.save(pegasos_mod_num)
    #num = len(os.listdir("../result"))
    
    df.to_csv("../results/regular/pegasos_results_test/res_pegasos_pauli_" + str(tau)+"_"+str(C) + ".csv", index = False)
...
def plot_confusion_matrix(conf_matrix, ansatz, optimizer):
    ...
    conf_num = "../vqc_conf/train_process/" + str(ansatz) + "_" + str(optimizer) + ".png"
...
def vqc_exp(ansatz, optimizer):
    ...
    vqc_mod_num = "../vqc_model/train_process/" + str(ansatz) + "_" + str(optimizer) + ".model"
    ...
    df.to_csv("../vqc_results/train_process/" + str(ansatz) + "_" + str(optimizer)  + ".csv", index = False)
